...
import 'model/shop_list_data.dart';
...
class ShopListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _bottomBarCardColor = (Theme.of(context).brightness != Brightness.dark)
        ? Colors.white70
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            child: Text(
                                              ' ${shopItem!.distance.toStringAsFixed(1)} km from you',
                                              overflow:
