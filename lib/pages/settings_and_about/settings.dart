...
class _SettingState extends State<SettingPage>{
  ...
  List<String> languageList = ['English','Français','Default'];// 'Lingala', 'Kiswahili'];
  var text;
  ...
  void initState() {
    super.initState();
    selectedIndex = BlocProvider.of<LanguageBloc>(context)
            .state.currentLangState.index;
    darkModeValue = BlocProvider.of<StyleAppTheme>(context)
  ...
  initObjectBox() async {
    ...
    setState(() {
      notifyValue = _data.isNotificationOn!;
      syncValue = _data.isSync!;
      //darkModeValue = false;
      //onLangChange = false;
    });
  ...
  _setSystemUIOverlayStyle(){
    SystemChrome.setSystemUIOverlayStyle(
        SystemUiOverlayStyle(
          ...
          systemNavigationBarColor: context.read<StyleAppTheme>().state.primaryColor,
        )
    );
  }
                  ...
                  Card(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        ListTile(
                          leading: Icon((darkModeValue)
                              ?Icons.brightness_3
                              :Icons.brightness_5,
                            color: iconColor,
                          ),
                          title: Text("Theme Mode",style: textStyleSet),
                          subtitle: Text((darkModeValue)?"Dark Mode ON":"Dark Mode OFF"),
                          trailing: Switch(
                                    ...
                                    children: List<Widget>.generate(languageList.length, (index) {
                                      return RadioListTile(
                                          ...
                                          onChanged: (value) {
                                            ...
                                            BlocProvider.of<LanguageBloc>(context).switchLang(LangState.values[selectedIndex]);
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            ...
                            onTap: (){
                              ...
                              Navigator.push(
                                  context,
                                  AboutPage.route(isSystemSet: true)
                              );
                            },
                          ),
                          ListTile(
                            title: Text("Version",style: textStyleSet,),
                            subtitle: Text("non-stable : $version  ",),
                          )
                        ],
                      ),
                    ),
