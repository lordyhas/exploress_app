...
final Color a = Colors.deepPurpleAccent;
final Color accentColorLight = Colors.green;
final Color accentColorDark = Colors.green;

final Color secondaryOrange = Colors.deepOrange.shade800;
final Color secondaryPurple = Colors.deepPurple;

final Color scaffoldBackgroundColor = Colors.grey.shade200;
...
class StyleAppTheme extends Cubit<ThemeData> {
  ...
  static final Color primaryPurple = Colors.deepPurple;
  ...
  static final Color secondaryPurple = Colors.deepPurple;
  ...
  static final _lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodyText1: TextStyle(color: primaryWhite,),
      bodyText2: TextStyle(color: primaryBlack,),
